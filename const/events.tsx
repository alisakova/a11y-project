...
export const allEvents = [
  ...
  },
  {
    ...
    imgAlt:
      // eslint-disable-next-line max-len
      "Картина Мунка 'Вечер на улице Карла Юхана'. Слева на картине толпа людей, а справа линия дороги, уводящая зрителя вглубь картины",
...
export const todayEvents = [
  ...
  },
  {
    ...
    imgAlt:
      // eslint-disable-next-line max-len
      "Картина Мунка 'Вечер на улице Карла Юхана'. Слева на картине толпа людей, а справа линия дороги, уводящае зрителя вглубь картины",
    title: "От Мунка до Босха. Самые загадочные картины мира",
    titleLink: "/",
    subtitle: "Только 14 и 15 ноября",
    text: "Выставка приглашает соприкоснуться с тайнами произведений известных художников",
...
export const tomorrowEvents = [
  {
    img: "/card6.jpeg",
    imgAlt:
      "Глубокий лес, есть березы, срубленные деревья, множество мелкой растительности",
