...
export const Lectures = () => {
  return (
    <section id="lectures" className="mb-28">
      ...
      <a href="/" className="text-xl text-blue-800 border-b mb-4 inline-block hover:border-transparent">Подробнее</a>
      <p className="max-w-xl text-xl">
        Мы будем благодарны за любое <a href="/" className="text-xl text-blue-800 border-b hover:border-transparent">пожертвование</a>. Все поступившие средства будут направлены на организацию онлайн-проектов для наших посетителей.
      </p>
    </section>
  )
}